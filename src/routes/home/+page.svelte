...
<div class="relative overflow-hidden bg-gradient-to-r from-green-600 to-teal-500 text-white">
	...
	<div class="absolute -top-16 -left-16 h-64 w-64 rounded-full bg-green-500 opacity-20"></div>
	<div class="absolute -right-20 bottom-10 h-80 w-80 rounded-full bg-teal-400 opacity-10"></div>

	<div class="relative container mx-auto px-4 py-20 sm:py-24">
		<div class="flex flex-col items-center lg:flex-row">
			<!-- Hero Content with improved typography -->
			<div
				class="mb-12 transition-all duration-700 lg:mb-0 lg:w-1/2"
				class:translate-y-0={pageLoaded}
				class:translate-y-4={!pageLoaded}
			...
			>
				...
				{#if isLoggedIn}
					<button
						...
						class="rounded-full bg-white px-8 py-4 font-bold text-green-600 shadow-lg transition-all duration-300 hover:scale-105 hover:transform hover:bg-gray-100 hover:shadow-xl focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-600 focus:outline-none"
					>
						Go to Dashboard
					</button>
				{:else}
					<div class="flex flex-wrap gap-4">
						...
						<a
							href="/register"
							class="rounded-full border-2 border-white px-8 py-4 font-bold text-white transition-all duration-300 hover:scale-105 hover:transform hover:bg-white hover:text-green-600 hover:shadow-lg focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-green-600 focus:outline-none"
						>
							Sign Up
						</a>
					</div>
			...
			<div
				class="transition-all delay-200 duration-700 lg:w-1/2 lg:pl-12"
				class:translate-y-0={pageLoaded}
				class:translate-y-4={!pageLoaded}
				class:opacity-100={pageLoaded}
				class:opacity-0={!pageLoaded}
			>
				<div class="relative">
					...
					<div
						class="absolute -right-4 -bottom-4 h-full w-full rounded-lg bg-green-300 opacity-30"
					></div>
					...
					<div class="relative rounded-lg bg-white p-3 shadow-2xl">
						...
						<div
							class="absolute inset-0 rounded-lg bg-gradient-to-tr from-green-600/10 to-transparent"
						></div>
					</div>
				</div>
			</div>
...
<div class="relative overflow-hidden bg-white py-20">
	<!-- Decorative shapes -->
	<div
		class="absolute top-0 left-0 h-64 w-64 -translate-x-1/2 -translate-y-1/2 rounded-full bg-green-50"
	></div>
	<div
		class="absolute right-0 bottom-0 h-96 w-96 translate-x-1/3 translate-y-1/3 rounded-full bg-green-50"
	></div>

	<div class="relative container mx-auto px-4">
		<h2 class="mb-16 text-center text-3xl font-bold text-gray-900 md:text-4xl">
			Why Choose Sugar Tracker?
		</h2>

		<div class="grid gap-8 md:grid-cols-3">
			<div
				class="group rounded-xl bg-white p-8 shadow-md transition-all duration-300 hover:-translate-y-2 hover:shadow-xl"
			>
				<div
...
<!-- Section divider -->
<div class="w-full bg-gradient-to-r from-green-50 via-green-100 to-green-50 py-6">
	<div class="mx-auto max-w-7xl px-4">
		<div class="mx-auto h-1 w-32 rounded-full bg-green-500"></div>
	</div>
</div>
